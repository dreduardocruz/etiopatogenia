...
\documentclass[12pt,oneside,a4paper]{book} %international style
...
\usepackage[top=2.0cm, left=1.0cm, right=1.0cm, bottom=2.0cm]{geometry}
...
%nie pozostawia wdow i sierot pojedynczych
